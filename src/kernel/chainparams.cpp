...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed.beta.ecash.ninja.");
        vSeeds.emplace_back("seed.beta.bip300.xyz.");
        vSeeds.emplace_back("seed.beta.ecash.drivecha.in.");
        vSeeds.emplace_back("seed.beta.ecash.zuexeuz.net.");
